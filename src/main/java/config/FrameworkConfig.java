...
import exceptions.APIAutomationFrameworkException;
...
public class FrameworkConfig {
    ...
    public static FrameworkConfig getInstance() {
        if (instance == null) {
            instance = new FrameworkConfig(LogConstants.FRAMEWORK_CONFIG_FILE_PATH);
        }
        return instance;
    }
    ...
    private Properties getProperties(final String filePath) {
        ...
        try (InputStream input = new FileInputStream(filePath)) {
            ...
            throw new APIAutomationFrameworkException(LogConstants.CANNOT_GET_PROPERTIES_FROM_FILE, e);
        }
